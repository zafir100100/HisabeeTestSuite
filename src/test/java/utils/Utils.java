...
public class Utils {
    /**
     * Takes a screenshot from the provided AndroidDriver instance and saves it to a specified location.
     *
     * @param driver The AndroidDriver instance from which to take the screenshot.
     * @throws IOException If there is an error in writing the screenshot to the file system.
     */
